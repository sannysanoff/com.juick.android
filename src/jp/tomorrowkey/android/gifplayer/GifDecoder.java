...
public class GifDecoder {
    ...
    public GifDecoder(boolean downscale) {
	...
	protected void readBitmap() {
        ...
        if (downscale) {
            ...
            imageToSave = Bitmap.createScaledBitmap(image, nw, nh, true);
        }

		frames.addElement(new GifFrame(imageToSave, delay)); // add image to frame
		// list
		if (transparency) {
			act[transIndex] = save;
		}
